...
WHAT IT DOES:
  ...
  3. Generates a grounded answer using Gemini
...
# Gemini is used for routing and grounded answer generation.
# Gemini Flash uses the provider's default sampling configuration.
...
#   2. Gemini generates text based on the prompt
